...
export default function Maker({ lang, isDark }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error(e);
      if (e.code === 'permission-denied' || e.code === 'firestore/permission-denied' || e.message.includes('permissions')) {
